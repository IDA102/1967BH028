#ifndef __DEF1967VN34R1_H_
#define __DEF1967VN34R1_H_
...
#define UART1_BASE    		0x80000120
#define SPI_BASE      		0x80000140
#define LCD_BASE      		0x80000160
#define VBUF_BASE     		0x80000180
#define VIDEO_BASE    		0x800001a0
#define CMU_BASE      		0x800001c0
#define RTC_BASE      		0x800001e0
#define I2S0_BASE     		0x80000200
#define I2S1_BASE     		0x80000220
#define NAND_BASE     		0x80000240
#define UDDC0_BASE     		0x80000280
#define UDDC1_BASE     		0x80000260
#define UDDC2_BASE     		0x800002A0
#define UDDC3_BASE     		0x800002C0
#define MILSTD0_BASE  		0x80006000
#define MILSTD1_BASE  		0x80007000

#define GPA_BASE      		0x80001000
#define GPB_BASE      		0x80001040
#define GPC_BASE      		0x80001080
#define ARINC_RX_BASE 		0x80002000
#define ARINC_TX_BASE 		0x80003000
#define ARINC_RX_MEM_BASE 	0x80002400
#define ARINC_TX_MEM_BASE 	0x80003400

#define ARINC_LAB0_BASE 	0x800027e0

#define DIGCORR_BASE  		0x80005000
#define BROM_BASE     		0x80008000

#define GPX_BASE      		0x80000090
#define EBIU_BASE     		0x80000080

#define DMACFGL_BASE  		0x80000078
#define DMACFGH_BASE  		0x80000079
...
// ARINC RX
#define ARINT_RX_CH0_BASE			(ARINC_RX_BASE+0x000)
#define ARINT_RX_CH1_BASE			(ARINC_RX_BASE+0x004)
#define ARINT_RX_CH2_BASE			(ARINC_RX_BASE+0x008)
#define ARINT_RX_CH3_BASE			(ARINC_RX_BASE+0x00C)
#define ARINT_RX_CH4_BASE			(ARINC_RX_BASE+0x010)
#define ARINT_RX_CH5_BASE			(ARINC_RX_BASE+0x014)
#define ARINT_RX_CH6_BASE			(ARINC_RX_BASE+0x018)
#define ARINT_RX_CH7_BASE			(ARINC_RX_BASE+0x01C)

#define ARINC_RX_CH0_CR_LOC			(ARINC_RX_CH0_BASE+0x000)
#define ARINC_RX_CH0_RSV_LOC		(ARINC_RX_CH0_BASE+0x001)
#define ARINC_RX_CH0_DATA_LOC		(ARINC_RX_CH0_BASE+0x002)
#define ARINC_RX_CH0_STATUS_LOC		(ARINC_RX_CH0_BASE+0x003)

#define ARINC_RX_CH1_CR_LOC			(ARINC_RX_CH1_BASE+0x000)
#define ARINC_RX_CH1_RSV_LOC		(ARINC_RX_CH1_BASE+0x001)
#define ARINC_RX_CH1_DATA_LOC		(ARINC_RX_CH1_BASE+0x002)
#define ARINC_RX_CH1_STATUS_LOC		(ARINC_RX_CH1_BASE+0x003)

#define ARINC_RX_CH2_CR_LOC			(ARINC_RX_CH2_BASE+0x000)
#define ARINC_RX_CH2_RSV_LOC		(ARINC_RX_CH2_BASE+0x001)
#define ARINC_RX_CH2_DATA_LOC		(ARINC_RX_CH2_BASE+0x002)
#define ARINC_RX_CH2_STATUS_LOC		(ARINC_RX_CH2_BASE+0x003)

#define ARINC_RX_CH3_CR_LOC			(ARINC_RX_CH3_BASE+0x000)
#define ARINC_RX_CH3_RSV_LOC		(ARINC_RX_CH3_BASE+0x001)
#define ARINC_RX_CH3_DATA_LOC		(ARINC_RX_CH3_BASE+0x002)
#define ARINC_RX_CH3_STATUS_LOC		(ARINC_RX_CH3_BASE+0x003)

#define ARINC_RX_CH4_CR_LOC			(ARINC_RX_CH4_BASE+0x000)
#define ARINC_RX_CH4_RSV_LOC		(ARINC_RX_CH4_BASE+0x001)
#define ARINC_RX_CH4_DATA_LOC		(ARINC_RX_CH4_BASE+0x002)
#define ARINC_RX_CH4_STATUS_LOC		(ARINC_RX_CH4_BASE+0x003)

#define ARINC_RX_CH5_CR_LOC			(ARINC_RX_CH5_BASE+0x000)
#define ARINC_RX_CH5_RSV_LOC		(ARINC_RX_CH5_BASE+0x001)
#define ARINC_RX_CH5_DATA_LOC		(ARINC_RX_CH5_BASE+0x002)
#define ARINC_RX_CH5_STATUS_LOC		(ARINC_RX_CH5_BASE+0x003)

#define ARINC_RX_CH6_CR_LOC			(ARINC_RX_CH6_BASE+0x000)
#define ARINC_RX_CH6_RSV_LOC		(ARINC_RX_CH6_BASE+0x001)
#define ARINC_RX_CH6_DATA_LOC		(ARINC_RX_CH6_BASE+0x002)
#define ARINC_RX_CH6_STATUS_LOC		(ARINC_RX_CH6_BASE+0x003)

#define ARINC_RX_CH7_CR_LOC			(ARINC_RX_CH7_BASE+0x000)
#define ARINC_RX_CH7_RSV_LOC		(ARINC_RX_CH7_BASE+0x001)
#define ARINC_RX_CH7_DATA_LOC		(ARINC_RX_CH7_BASE+0x002)
#define ARINC_RX_CH7_STATUS_LOC		(ARINC_RX_CH7_BASE+0x003)

#define ARINC_RX_MEM0_LOC			(ARINC_RX_MEM_BASE+0x000)
#define ARINC_RX_MEM1_LOC			(ARINC_RX_MEM_BASE+0x100)
#define ARINC_RX_MEM2_LOC			(ARINC_RX_MEM_BASE+0x200)
#define ARINC_RX_MEM3_LOC			(ARINC_RX_MEM_BASE+0x240)
#define ARINC_RX_MEM4_LOC			(ARINC_RX_MEM_BASE+0x280)
#define ARINC_RX_MEM5_LOC			(ARINC_RX_MEM_BASE+0x2C0)
#define ARINC_RX_MEM6_LOC			(ARINC_RX_MEM_BASE+0x300)
#define ARINC_RX_MEM7_LOC			(ARINC_RX_MEM_BASE+0x320)
#define ARINC_RX_LABEL0_LOC			(ARINC_RX_MEM_BASE+0x3C0)
#define ARINC_RX_LABEL1_LOC			(ARINC_RX_MEM_BASE+0x3C8)
#define ARINC_RX_LABEL2_LOC			(ARINC_RX_MEM_BASE+0x3D0)
#define ARINC_RX_LABEL3_LOC			(ARINC_RX_MEM_BASE+0x3D8)
#define ARINC_RX_LABEL4_LOC			(ARINC_RX_MEM_BASE+0x3E0)
#define ARINC_RX_LABEL5_LOC			(ARINC_RX_MEM_BASE+0x3E8)
#define ARINC_RX_LABEL6_LOC			(ARINC_RX_MEM_BASE+0x3F0)
#define ARINC_RX_LABEL7_LOC			(ARINC_RX_MEM_BASE+0x3F8)

// ARINC TX
#define ARINT_TX_CH0_BASE			(ARINC_TX_BASE+0x000)
#define ARINT_TX_CH1_BASE			(ARINC_TX_BASE+0x004)
#define ARINT_TX_CH2_BASE			(ARINC_TX_BASE+0x008)
#define ARINT_TX_CH3_BASE			(ARINC_TX_BASE+0x00C)

#define ARINC_TX_CH0_CR_LOC			(ARINC_TX_CH0_BASE+0x000)
#define ARINC_TX_CH0_RSV_LOC		(ARINC_TX_CH0_BASE+0x001)
#define ARINC_TX_CH0_DATA_LOC		(ARINC_TX_CH0_BASE+0x002)
#define ARINC_TX_CH0_STATUS_LOC		(ARINC_TX_CH0_BASE+0x003)

#define ARINC_TX_CH1_CR_LOC			(ARINC_TX_CH1_BASE+0x000)
#define ARINC_TX_CH1_RSV_LOC		(ARINC_TX_CH1_BASE+0x001)
#define ARINC_TX_CH1_DATA_LOC		(ARINC_TX_CH1_BASE+0x002)
#define ARINC_TX_CH1_STATUS_LOC		(ARINC_TX_CH1_BASE+0x003)

#define ARINC_TX_CH2_CR_LOC			(ARINC_TX_CH2_BASE+0x000)
#define ARINC_TX_CH2_RSV_LOC		(ARINC_TX_CH2_BASE+0x001)
#define ARINC_TX_CH2_DATA_LOC		(ARINC_TX_CH2_BASE+0x002)
#define ARINC_TX_CH2_STATUS_LOC		(ARINC_TX_CH2_BASE+0x003)

#define ARINC_TX_CH3_CR_LOC			(ARINC_TX_CH3_BASE+0x000)
#define ARINC_TX_CH3_RSV_LOC		(ARINC_TX_CH3_BASE+0x001)
#define ARINC_TX_CH3_DATA_LOC		(ARINC_TX_CH3_BASE+0x002)
#define ARINC_TX_CH3_STATUS_LOC		(ARINC_TX_CH3_BASE+0x003)

#define ARINC_TX_MEM0_LOC			(ARINC_TX_MEM_BASE+0x000)
#define ARINC_TX_MEM1_LOC			(ARINC_TX_MEM_BASE+0x100)
#define ARINC_TX_MEM2_LOC			(ARINC_TX_MEM_BASE+0x140)
#define ARINC_TX_MEM3_LOC			(ARINC_TX_MEM_BASE+0x180)
...
// GPC
#define GPC_DR_LOAD_LOC			(GPC_BASE + PiDR_LOAD_offset)
#define GPC_DR_SET_LOC			(GPC_BASE + PiDR_SET_offset)
#define GPC_DR_CLEAR_LOC		(GPC_BASE + PiDR_CLEAR_offset)
#define GPC_DR_INV_LOC			(GPC_BASE + PiDR_INV_offset)
#define GPC_DDR_LOAD_LOC		(GPC_BASE + PiDDR_LOAD_offset)
#define GPC_DDR_SET_LOC			(GPC_BASE + PiDDR_SET_offset)
#define GPC_DDR_CLEAR_LOC		(GPC_BASE + PiDDR_CLEAR_offset)
#define GPC_DDR_INV_LOC			(GPC_BASE + PiDDR_INV_offset)
#define GPC_PEIE_LOAD_LOC		(GPC_BASE + PiPEIE_LOAD_offset)
#define GPC_PEIE_SET_LOC		(GPC_BASE + PiPEIE_SET_offset)
#define GPC_PEIE_CLEAR_LOC		(GPC_BASE + PiPEIE_CLEAR_offset)
#define GPC_PEIE_INV_LOC		(GPC_BASE + PiPEIE_INV_offset)
#define GPC_NEIE_LOAD_LOC		(GPC_BASE + PiNEIE_LOAD_offset)
#define GPC_NEIE_SET_LOC		(GPC_BASE + PiNEIE_SET_offset)
#define GPC_NEIE_CLEAR_LOC		(GPC_BASE + PiNEIE_CLEAR_offset)
#define GPC_NEIE_INV_LOC		(GPC_BASE + PiNEIE_INV_offset)
#define GPC_INVR_LOAD_LOC		(GPC_BASE + PiINVR_LOAD_offset)
#define GPC_INVR_SET_LOC		(GPC_BASE + PiINVR_SET_offset)
#define GPC_INVR_CLEAR_LOC		(GPC_BASE + PiINVR_CLEAR_offset)
#define GPC_INVR_INV_LOC		(GPC_BASE + PiINVR_INV_offset)
#define GPC_IMR_LOAD_LOC		(GPC_BASE + PiIMR_LOAD_offset)
#define GPC_IMR_SET_LOC			(GPC_BASE + PiIMR_SET_offset)
#define GPC_IMR_CLEAR_LOC		(GPC_BASE + PiIMR_CLEAR_offset)
#define GPC_IMR_INV_LOC			(GPC_BASE + PiIMR_INV_offset)
#define GPC_ALT_LOAD_LOC		(GPC_BASE + PiALT_LOAD_offset)
#define GPC_ALT_SET_LOC			(GPC_BASE + PiALT_SET_offset)
#define GPC_ALT_CLEAR_LOC		(GPC_BASE + PiALT_CLEAR_offset)
#define GPC_ALT_INV_LOC			(GPC_BASE + PiALT_INV_offset)
#define GPC_PUR_LOAD_LOC		(GPC_BASE + PiPUR_LOAD_offset)
#define GPC_PUR_SET_LOC			(GPC_BASE + PiPUR_SET_offset)
#define GPC_PUR_CLEAR_LOC		(GPC_BASE + PiPUR_CLEAR_offset)
#define GPC_PUR_INV_LOC			(GPC_BASE + PiPUR_INV_offset)
#define GPC_PXD_LOC				(GPC_BASE + PiPXD_offset)
#define GPC_INTREQ_LOC			(GPC_BASE + PiINTREQ_offset)
#define GPC_ECLR_LOC			(GPC_BASE + PiECLR_offset)
// Aliases
...
#define PXD_LOAD_LOC			(GPX_BASE + PXD_LOAD_offset)
#define PXD_DR_LOC				PXD_LOAD_LOC	// alias
#define PXD_SET_LOC				(GPX_BASE + PXD_SET_offset)
#define PXD_CLEAR_LOC			(GPX_BASE + PXD_CLEAR_offset)
#define PXD_DIR_LOC				(GPX_BASE + PXD_DIR_offset)

#define PXA_LOAD_LOC			(GPX_BASE + PXA_LOAD_offset)
#define PXA_DR_LOC				PXA_LOAD_LOC	// alias
#define PXA_SET_LOC				(GPX_BASE + PXA_SET_offset)
#define PXA_CLEAR_LOC			(GPX_BASE + PXA_CLEAR_offset)
// PXA only output


#define PX_ALT_LOC				(GPX_BASE + PX_ALT_offset)
...
#define PXD_PIN_LOC				(GPX_BASE + PXD_PIN_offset)
#define PXD_PU_LOC				(GPX_BASE + PXD_PU_offset)
...
#define SPCR0_LOC					(SPI_BASE + 0)
#define SPCR1_LOC					(SPI_BASE + 1)
#define SPDR_LOC					(SPI_BASE + 2)
#define SPSR_LOC					(SPI_BASE + 3)
#define SPRXCNT_LOC					(SPI_BASE + 4)
...
#define CMU_CFG1_LOC			(CMU_BASE + 0)	// CFG_APB
#define CMU_CFG2_LOC			(CMU_BASE + 1)	// CFG_cPLL
#define CMU_CFG3_LOC			(CMU_BASE + 2)	// CFG_xPLL
#define CMU_CFG4_LOC			(CMU_BASE + 3)	// CFG4
#define CMU_CFG5_LOC			(CMU_BASE + 4)	// CFG_lPLL
#define CMU_SYS_STS_LOC			(CMU_BASE + 5)
#define CMU_CLKDIS_LOC			(CMU_BASE + 0x8)
#define CMU_CLKDIS_LOAD_LOC		(CMU_BASE + 0x8)
#define CMU_CLKDIS_SET_LOC		(CMU_BASE + 0x9)
#define CMU_CLKDIS_CLEAR_LOC	(CMU_BASE + 0xA)
#define CMU_CFG8_LOAD_LOC		(CMU_BASE + 0x8)
#define CMU_CFG8_SET_LOC		(CMU_BASE + 0x9)
#define CMU_CFG8_CLEAR_LOC		(CMU_BASE + 0xA)
...
//-------------------------------------------------------//
// Base Addresses (in new version: base_ changes _BASE)
...
//-------------------------------------------------------//
// ADA (in new version: ADA changes UDDC)
